...
const env = {
  ...
  FONT_FAMILY_SERIF:
    process.env.FONT_FAMILY_SERIF || "minerva-modern, sans-serif",
  ...
  SITE_OG_IMAGE:
    ...
    "https://static.mineralcdn.net/site/mineral-store-v2/og_image.png",
  SITE_LOGO_HEIGHT: process.env.SITE_LOGO_HEIGHT || "inherit",
  SITE_LOGO_URL:
    process.env.SITE_LOGO_URL ||
    "https://static.mineralcdn.net/site/mineral-store-v2/logo.png",
  SITE_ICONS_PATH:
    process.env.SITE_ICONS_PATH ||
    "https://static.mineralcdn.net/site/mineral-store-v2/icon",
  APP_IOS: process.env.APP_IOS || null,
  APP_ANDROID: process.env.APP_ANDROID || null,

  FOOTER_COPYRIGHT:
    process.env.FOOTER_COPYRIGHT ||
    `&copy; ${new Date().getFullYear()} ${
      process.env.SITE_NAME || "Mineral Store"
    }.`,
  FOOTER_PAYMENT_LOGO_URL:
    process.env.FOOTER_PAYMENT_LOGO_URL ||
    "https://static.mineralcdn.net/payment/payment-qris-all-color.png",
  ...
  DISABLE_DUPLICATE_MOBILE_NUMBER:
    process.env.DISABLE_DUPLICATE_MOBILE_NUMBER || false,
...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        "primary-btn": env.COLOR_PRIMARY_BUTTON,
